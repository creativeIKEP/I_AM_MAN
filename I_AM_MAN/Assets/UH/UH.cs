/**********************************************************************************************
 *   UnlimitedHand for Unity Plugin ver 0040
 *   This code is used with an Arduino Code 
 *   "Serial_Unity_Quaternion" in UH4Arduino0041.zip.
 *   
 *   [Notification 1]
 ...
 * 
 *   [Notification 3]
 *   In this version, stimulate() is modified.
 *   You can adjust ThredSleep time and it is initialized to 1000 ms.
 * 
 *   [Notification 4]
